...
When you have threads, `async` may seem redundant, but it can actually make your application reduce memory usage.
...
[mabez.](https://mabez.dev/blog/posts/) [dev](https://mabez.dev/blog/posts/)[/blog](https://mabez.dev/blog/posts/)](https://mabez.dev/blog/posts/) - The history of supporting Rust on Espressif chips
<!-- TODO social links? -->